...
export interface ApiAlmacenAlmacen extends Schema.CollectionType {
...
export interface ApiMovimientoDeInventarioMovimientoDeInventario
  extends Schema.CollectionType {
  ...
  attributes: {
    tipo: Attribute.Enumeration<['Entrada', 'Salida']>;
    cantidad: Attribute.Integer;
    fecha: Attribute.Date;
    razon: Attribute.Text;
    productos: Attribute.Relation<
      'api::movimiento-de-inventario.movimiento-de-inventario',
      'oneToMany',
      'api::producto.producto'
    >;
    almacenes: Attribute.Relation<
      'api::movimiento-de-inventario.movimiento-de-inventario',
      'oneToMany',
      'api::almacen.almacen'
    >;
...
export interface ApiProductosEnEventoProductosEnEvento
  extends Schema.CollectionType {
...
export interface ApiStockAlmacenStockAlmacen extends Schema.CollectionType {
  collectionName: 'stock_almacens';
  info: {
    singularName: 'stock-almacen';
    pluralName: 'stock-almacens';
    displayName: 'StockAlmacen';
    description: '';
  };
  options: {
    draftAndPublish: true;
  ...
  attributes: {
    cantidad: Attribute.Integer;
    productos: Attribute.Relation<
      'api::stock-almacen.stock-almacen',
      'oneToMany',
      'api::producto.producto'
    >;
    almacenes: Attribute.Relation<
...
export interface ApiTransferenciaProductoTransferenciaProducto
  extends Schema.CollectionType {
  ...
  attributes: {
    cantidad: Attribute.Integer;
    fecha: Attribute.Date;
    estatus: Attribute.Enumeration<['Pendiente', 'Completado']>;
    productos: Attribute.Relation<
      'api::transferencia-producto.transferencia-producto',
      'oneToMany',
      'api::producto.producto'
    >;
    almacens: Attribute.Relation<
      'api::transferencia-producto.transferencia-producto',
      'oneToMany',
      'api::almacen.almacen'
    >;
...
declare module '@strapi/types' {
  export module Shared {
    export interface ContentTypes {
      ...
      'api::movimiento-de-inventario.movimiento-de-inventario': ApiMovimientoDeInventarioMovimientoDeInventario;
      'api::producto.producto': ApiProductoProducto;
      'api::productos-en-evento.productos-en-evento': ApiProductosEnEventoProductosEnEvento;
      'api::stock-almacen.stock-almacen': ApiStockAlmacenStockAlmacen;
      'api::transferencia-producto.transferencia-producto': ApiTransferenciaProductoTransferenciaProducto;
    }
  }
}
