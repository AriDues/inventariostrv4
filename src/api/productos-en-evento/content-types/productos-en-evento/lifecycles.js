...
module.exports = {
    ...
    async beforeUpdate(event) {
        ...
        if (isBeforeUpdateRunning) {
         ...
         try {
             const { params, where } = event;; // El registro actualizado y los parámetros de la actualización
            ...
            //console.log(" ProductoEnEvento beforeUpdate ***** " + JSON.stringify(getEvento, null, 2));
             ...
             const { estatus, cantidad } = params.data;
      
             // Verificar si el campo "estatus" fue modificado
             if (estatus) {
                 if (estatus === 'Devuelto') {
                     // Crear un movimiento de inventario de tipo "Entrada"
                 ...
                 console.log('Producto devuelto al inventario:', ProductoEnEvento.producto[0].Nombre);
